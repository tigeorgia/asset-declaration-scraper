...
return
(
'#Unique ID for each person is generated using  string-to-codepoints(string-join(($firstName,$lastName,$BirthDate),";")).
You can generate the Name, birthday string back by tiUtil:PersonID2Name($PersonID)
# Schema
#ID generated from ENG name ID generated from GEO name  DocumentID'
,
tiUtil:trTOcsv ($JoinTable)
 )
